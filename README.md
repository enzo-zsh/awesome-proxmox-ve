# Awesome Proxmox [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

A nice collection of cool things related to Proxmox VE such like awesome tools, scripts, and resources for the **Proxmox Virtual Environment (PVE)** ecosystem.
...
* [PVEcontrol](https://github.com/enix/pvecontrol)
...
* [proxmox-mcp-openapi (AI)](https://www.npmjs.com/package/@bakhshb/proxmox-mcp-openapi)
* [Terraform Provider for Proxmox](https://registry.terraform.io/providers/bpg/proxmox/latest)
* [Ansible Collection for Proxmox](https://galaxy.ansible.com/ui/repo/published/community/general/)
